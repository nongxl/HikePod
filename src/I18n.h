...
enum TextId {
    ...
    // Debug 面板诊断提示
    T_DEBUG_GPS_OFF,
    T_DEBUG_GPS_START_HINT,
    T_DEBUG_GPS_NO_DATA,
    T_DEBUG_GPS_FOUND_ALT_PREFIX,
    T_DEBUG_GPS_SWITCH_HINT,
    T_DEBUG_GPS_FIX_TIMEOUT,

    // 自动检测到新 GPS 模块确认弹窗
    T_DIALOG_GPS_DETECTED_TITLE,
    T_DIALOG_GPS_DETECTED_PROMPT,
    T_DIALOG_GPS_CONFIRM,
    T_DIALOG_GPS_CANCEL,
